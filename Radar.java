...
/**
 * This class represents the Radar pickup.
 * When picked up, the location of the briefcase is revealed indefinitely.
 * 
 * @author Zhihang Yao(Evan)
 */
public class Radar extends PickUp {
	
	public Radar(int[] loc, boolean isActive) {
		super(loc, isActive);
	}

	/** 
	 * Reveals the location of the briefcase indefinitely.
	 * 
